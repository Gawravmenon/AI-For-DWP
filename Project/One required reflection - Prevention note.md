...
The AI model came up with a model that was not an industry standard and hence I have asked to update it with an industry standard application and that file is saved as Prevention note.
